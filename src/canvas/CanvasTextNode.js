 ...
 */
function domOffsetToCharIndex(div, targetNode, targetOffset) {
 ...
 */
function charIndexToDomOffset(div, charIndex) {
...
export function CanvasTextNode({ obj, isSelected, onSelect, onGuidesChange }) {
    ...
    useEffect(() => {
        const onDown = (e) => { if (e.key === 'Meta')
            cmdHeldRef.current = true; };
        const onUp = (e) => { if (e.key === 'Meta')
    ...
    function handleDblClick() {
        ...
        const originalSpans = obj.spans.map((s) => ({ ...s }));
        const editScale = CANVAS_SCALE * zoom;
        ...
        function finish() {
            ...
            const currentObj = useCanvasStore.getState().objects[obj.id];
            ...
            if (spansChanged) {
                commitUpdate(obj.id, { spans: finalSpans });
            }
            setTextEditing(null);
            setTextSelection(null);
        }
    ...
    return (_jsxs(_Fragment, { children: [isInMultiSelect && (_jsx(Rect, { x: obj.x, y: obj.y, width: obj.width, height: obj.height, rotation: obj.rotation, fill: "transparent", stroke: "#0096ff", strokeWidth: 1, strokeScaleEnabled: false, perfectDrawEnabled: false, listening: false })), _jsx(KonvaText, { ref: textRef, x: obj.x, y: obj.y, width: obj.width, height: obj.height, rotation: obj.rotation, scaleX: obj.scaleX, scaleY: obj.scaleY, opacity: 0, text: spanText(obj), fontFamily: obj.fontFamily, fontSize: obj.fontSize, fontStyle: obj.fontStyle, align: obj.align, fill: obj.fill, letterSpacing: obj.letterSpacing, lineHeight: obj.lineHeight, wrap: "word", draggable: !obj.locked, onClick: (e) => {
                    if (e.evt.shiftKey) {
                ...
                }, onTap: onSelect, onDblClick: handleDblClick, onDragStart: () => {
                ...
                } }), _jsx(Transformer, { ref: transformerRef, keepRatio: false, enabledAnchors: [
                    'top-left', 'top-center', 'top-right',
                    'middle-right', 'bottom-right', 'bottom-center',
                    'bottom-left', 'middle-left',
