import { i as __toESM, n as __exportAll, t as __commonJSMin } from "./chunk-C-Qwzh9l.js";
import { t as require_react } from "./react.js";
import { t as require_scheduler } from "./scheduler-D7ak6kT9.js";
	...
	module.exports = function $$$reconciler($$$hostConfig) {
		...
		*/
		...
		function prepareToHydrateHostTextInstance(fiber) {
			...
			var shouldUpdate = hydrateTextInstance(textInstance, textContent, fiber, !didSuspendOrErrorDEV);
			if (shouldUpdate) {
		...
		*/
		...
		function ensureRootIsScheduled(root, currentTime) {
			...
			if (newCallbackPriority === SyncLane) {
				...
				if (supportsMicrotasks) if (ReactCurrentActQueue$1.current !== null) ReactCurrentActQueue$1.current.push(flushSyncCallbacks);
		...
		exports$1.attemptDiscreteHydration = attemptDiscreteHydration;
...
*/
//#endregion
export { Arc, Arrow, Circle, Ellipse, FastLayer, Group, Image, KonvaRenderer, Label, Layer, Line, Path, Rect, RegularPolygon, Ring, Shape, Sprite, Stage, Star, Tag, Text, TextPath, Transformer, Wedge, useContextBridge, useStrictMode, version };
